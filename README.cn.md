...
[![x-cmd/install — Logria Code Quality Monitoring Repo Card](https://repo.x-cmd.io/Logria.svg?lang=zh)](https://x-cmd.com/install/Logria)
...
合计: **7,085** 行代码（覆盖前 5 种语言、共 **53** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 7,038 | 504 | 1,086 | 44 |
| Toml | 25 | 3 | 2 | 1 |
| Sh | 21 | 11 | 8 | 1 |
| Svg | 1 | 0 | 0 | 1 |
| Markdown | 0 | 338 | 158 | 6 |

## 源代码

- **上游仓库**: <https://github.com/ReagentX/Logria>
- **许可证**: GPL-3.0
...
- **Star**: 108 · **Fork**: 4 · **开放 issue**: 45 · **贡献者**: 1

## 累计统计

- **发布数**: 16 · **已合并 PR**: 94 · **开放 PR**: 1 · **已关闭 issue**: 36 · **开放 issue**: 9 · **提交数**: 948

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-21 | 1 | 1 | 0 | 0 | 0 | 0 |
| last60d | 2026-07-22 | 1 | 1 | 0 | 0 | 0 | 11 |
| 90d | 2026-06-22 | 1 | 1 | 0 | 0 | 0 | 11 |
| last180d | 2026-03-24 | 1 | 1 | 0 | 0 | 0 | 11 |
| 360d | 2025-09-25 | 3 | 5 | 1 | 0 | 0 | 27 |
| last720d | 2024-09-30 | 12 | 19 | 1 | 9 | 1 | 102 |
...
Logria 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `Logria` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/Logria.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260920.yml` · 2026-09-20T04:52:05Z._
